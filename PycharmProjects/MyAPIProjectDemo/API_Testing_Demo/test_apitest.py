...
def test_api_post():
    ...
    assert data['name'] == "John", "User created with wrong name. Expected : John, but found : " + str(data['name'])
    assert data['job'] == "QA", "User created with wrong job. Expected : QA, but found : " + str(data['job'])